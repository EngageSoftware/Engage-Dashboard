...
<asp:MultiView ID="ChartsMultiview" runat="server" ActiveViewIndex="0" EnableViewState="false">
    <asp:View ID="ChartsView" runat="server">
        <asp:PlaceHolder ID="DatabaseSizeChartPlaceholder" runat="server" Visible="false">
        ...
        <asp:PlaceHolder ID="SeoPagesChartPlaceholder" runat="server" Visible="false">
        ...
        <asp:PlaceHolder ID="EventLogChartPlaceholder" runat="server" Visible="false">
